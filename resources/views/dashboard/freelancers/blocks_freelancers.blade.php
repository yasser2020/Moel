...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Freelancers المحظورين</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="container-fluid">
    <div class="card card-primary">
      <div class="card-header">
        ...
        <h3 class="card-title text-center">Freelancers المحظورين</h3>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover" >
                  ...
                  <tbody>
                    ...
                    <form action="{{route('dashboard.restoreFreelancer',$freelancer->id)}}" style="display:inline-block" method="post">
                       @csrf
                       @method('get')
                       @if (auth()->user()->hasPermission('delete_freelancers'))
                       <button type="submit" class="btn btn-success btn-sm restore_freelancer"><i class="fa fa-trash"> فك الحظر</i></button>
                           @else
