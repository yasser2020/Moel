...
<div class="container-fluid">
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
         <form role="form" action="{{route('dashboard.clientAdvantage.update',$clientAdavantage->id)}}" method="post">
            @csrf 
            @method('put')
          ...
          <div class="card-body">
            ...
            <input type="text" name="name" class="form-control" value="{{old('name',$clientAdavantage->name)}}">
            </div>
